...
function updateSubtotal(inputElement, price){
   ...
   // const checkoutLink = document.getElementById('checkoutLink');
	//update the quantity in the href
	//checkoutLink.href =	`cart?command=CHECKOUT&totalPrice=${totalPrice}&amount=${amount}`;
...
<body class="cart" onload="updateTotalPrice()">
	<!--[if lt IE 8]>
								...
								<li><a href="cart?command=VIEW_CART"><i
									...
									<div class="mini-cart-sub">
										...
										<div class="cart-bottom">
											<a class="view-cart" href="cart?command=VIEW_CART&amount=${amount}">view
												cart</a>  
										</div>
									</div></li>
							</ul>
							...
							<tbody>
								...
								<tr class="order-total">
									...
									<td><strong> <span class="amount"
											id="orderTotalAmount">${totalPrice}
										</span>
